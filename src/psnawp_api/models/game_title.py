...
class GameTitle:
    ...
    .. note::
        ...
        This class is only useful if the user has played that video game.
        See :py:meth:`psnawp_api.psnawp.PSNAWP.game_title` for more information.

    """

    def __init__(self, request_builder: RequestBuilder, title_id: str, account_id: str,
        ...
        .. note::
            ...
            During the construction of the object, an additional call is made to get the np_communication_id.
            This ID is important for getting trophy data.
    ...
    async def get_details(self, session: ClientSession = None) -> list[dict[str, Any]]:
        ...
        (Not all values are shown because of space limitations):
    ...
    def trophies(self, platform: Literal["PS Vita", "PS3", "PS4", "PS5"], trophy_group_id: str = "default",
                 limit: Optional[int] = None) -> AsyncIterator[Trophy]:
